...
/************************************************大拨盘旋转函数************************************************/
	...
	{
		Shooting.bulletNumber--;
	  Bullet.LargeCounter--;	
    Shooting.largeCheckFlag = 0;
	}
	
	if(Bullet.LargeCounter < 0)
  {
