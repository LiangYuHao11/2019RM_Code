...
//    powerBufferPool_t.pcurrentMeter_t = &currtenMeter_t;
    ...
    powerBufferPool_t.ramp_high_current_threshold = 25.0;//裁判系统测的电流峰值9A
    powerBufferPool_t.ramp_mid_current_threshold = 20.5;//裁判系统测的电流峰值7A
    powerBufferPool_t.ramp_low_current_threshold = 14.4;//裁判系统测的电流峰值7A
...
//    powerBufferPool_t.ramp_mid_current_threshold = 19.5;//裁判系统测的电流峰值7A
//    powerBufferPool_t.ramp_low_current_threshold = 14.4;//裁判系统测的电流峰值7A
//    powerBufferPool_t.ramp_safe_current_threshold = 6.2;//裁判系统测的电流峰值3.5A	
...
//    powerBufferPool_t.ramp_mid_water_level = 10.8;  //160.0;		
//    powerBufferPool_t.ramp_high_current_threshold = 23.0;//裁判系统测的电流峰值9A
//    powerBufferPool_t.ramp_mid_current_threshold = 18.5;//裁判系统测的电流峰值7A
//    powerBufferPool_t.ramp_low_current_threshold = 14.4;//裁判系统测的电流峰值7A
//    powerBufferPool_t.ramp_safe_current_threshold = 8.2;//裁判系统测的电流峰值3.5A
