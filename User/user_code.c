...
//     ANO_Send_Data_V3(SCCM_ReceiveData.cap_usable,abs(M3508s[0].realSpeed),SCCM_ReceiveData.cap_level,SCCM_Status.sccmControlMode);
...
//ANO_Send_Data_V3(ext_power_heat_data.data.chassis_power_buffer,Chassis_Angle,pid_state,power_state);
